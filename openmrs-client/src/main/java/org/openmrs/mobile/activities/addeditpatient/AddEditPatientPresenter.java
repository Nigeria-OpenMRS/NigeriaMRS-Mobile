...
public class AddEditPatientPresenter extends BasePresenter implements AddEditPatientContract.Presenter {
    ...
    @Override
    public void updatePatientIdentifier(Patient patient, PatientIdentifier identifier) {
        patientApi.updatePatientIdentifier(patient,identifier, new DefaultResponseCallbackListener() {
            @Override
            public void onResponse() {
                mPatientInfoView.finishPatientInfoActivity();
            }
