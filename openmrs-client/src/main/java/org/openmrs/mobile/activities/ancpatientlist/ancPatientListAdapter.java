...
public class ancPatientListAdapter extends RecyclerView.Adapter<ancPatientListAdapter.PatientViewHolder> {
    private ancPatientListFragment mContext;
    private List<Patient> mItems;

    public ancPatientListAdapter(ancPatientListFragment context, List<Patient> items) {
