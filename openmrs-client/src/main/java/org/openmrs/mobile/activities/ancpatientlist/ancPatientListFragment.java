...
import org.openmrs.mobile.activities.formentrypatientlist.FormEntryPatientListAdapter;
...
public class ancPatientListFragment extends ACBaseFragment<ancPatientListContract.Presenter> implements  ancPatientListContract.View {
    ...
    public void updateAdapter(List<Patient> patientList) {
        ancPatientListAdapter adapter = new ancPatientListAdapter(this,patientList);
    ...
    public static ancPatientListFragment newInstance() {
        return new ancPatientListFragment();
    }
