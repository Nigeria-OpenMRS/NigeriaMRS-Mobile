...
public class ancPatientListPresenter extends BasePresenter implements ancPatientListContract.Presenter {

    private final ancPatientListContract.View mFormEntryPatientListView;
    private PatientDAO patientDAO;
    private String mQuery;

    public ancPatientListPresenter(ancPatientListContract.View view) {
        this.mFormEntryPatientListView = view;
        this.mFormEntryPatientListView.setPresenter(this);
        this.patientDAO = new PatientDAO();
    }

    public ancPatientListPresenter(ancPatientListContract.View view, PatientDAO patientDAO) {
        this.mFormEntryPatientListView = view;
        this.mFormEntryPatientListView.setPresenter(this);
