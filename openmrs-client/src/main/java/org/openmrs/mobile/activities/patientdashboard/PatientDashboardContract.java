...
public interface PatientDashboardContract {
    ...
    */
    ...
    interface ViewPatientEntries extends ViewPatientMain {
        void showErrorToast(String message);
        void dismissCurrentDialog();
//        void toggleRecyclerListVisibility(boolean isVisible);
        void startFormDisplayActivity(Encountercreate encountercreate);
        void setEmptyListVisibility(boolean visibility);
        void updateList(List<Encountercreate> visitEncounters);
//        void setEncountersToDisplay(List<Encountercreate> visits);
        void goToVisitDashboard(Long visitID);
        void showStartVisitDialog(boolean isVisitPossible);
        void showStartVisitProgressDialog();
    }
    ...
    */
    ...
    interface PatientEntriesPresenter extends PatientDashboardMainPresenter {
        void startFormDisplayActivityWithEncounter(Encountercreate encountercreate);
    }
