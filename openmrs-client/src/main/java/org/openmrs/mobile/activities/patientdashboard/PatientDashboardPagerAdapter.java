...
class PatientDashboardPagerAdapter extends FragmentPagerAdapter {
    ...
    private static final int ENTRIES_TAB_POS = 1;
    private static final int DIAGNOSIS_TAB_POS = 4;
//    private static final int VISITS_TAB_POS = 2;
    private static final int VITALS_TAB_POS = 3;
    private static final int CHARTS_TAB_POS = 5;
...
//                return patientVitalsFragment;
            ...
            case ENTRIES_TAB_POS:
                PatientEntriesFragment patientEntriesFragment = PatientEntriesFragment.newInstance();
                new PatientDashboardEntriesPresenter(mPatientId, patientEntriesFragment);
                return patientEntriesFragment;
            default:
                return null;
        }
    }
