...
public class VisitApi {
    ...
    public void startVisit(final Patient patient) {
        startVisit(patient, null,null);
    }

    public void startVisit(final Patient patient,String datetimes, @Nullable final StartVisitResponseListenerCallback callbackListener) {
        final Visit visit = new Visit();
//        visit.setStartDatetime(DateUtils.convertTime(System.currentTimeMillis(), DateUtils.OPEN_MRS_REQUEST_FORMAT));
        visit.setStartDatetime(datetimes);
...
//        visit.setVisitType(new VisitType(null, OpenMRS.getInstance().getVisitTypeUUID()));
        visit.setVisitType(new VisitType(null, "7b0f5697-27e3-40c4-8bae-f4049abfb4ed"));
