...
public class DBOpenHelper extends OpenMRSSQLiteOpenHelper {
    ...
    private EncounterCreateTable mEncounterCreateTable;
    ...
    public DBOpenHelper(Context context) {
        ...
        this.mEncounterCreateTable = new EncounterCreateTable();
    }
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL(mEncounterCreateTable.createTableDefinition());
        logOnCreate(mEncounterCreateTable.toString());
    }
    ...
    public long insertEncounterCreate(SQLiteDatabase db, Encountercreate encountercreate) {
        long encounterId;

        SQLiteStatement encounterCreateStatement = db.compileStatement(mEncounterCreateTable.insertIntoTableDefinition());

        try {
            db.beginTransaction();
            bindString(1, encountercreate.getEncounterProviders(), encounterCreateStatement);
            bindLong(4, encountercreate.getEncounterDatetime(), encounterCreateStatement);
            bindString(5, encountercreate.getEncounterType(), encounterCreateStatement);
            bindString(2, encountercreate.getFormname(), encounterCreateStatement);
            bindString(3, encountercreate.getPatient(), encounterCreateStatement);
            bindString(6, encountercreate.getVisit(), encounterCreateStatement);
//            bindString(7, encountercreate.g(), encounterCreateStatement);
            encounterId = encounterCreateStatement.executeInsert();
            encounterCreateStatement.clearBindings();
            db.setTransactionSuccessful();
        } finally {
            db.endTransaction();
            encounterCreateStatement.close();
        }
        return encounterId;
    }

    public int updateEncounterCreate(SQLiteDatabase db, long encounterID, Encountercreate encounter) {
        ContentValues newValues = new ContentValues();
//        newValues.put(EncounterTable.Column.UUID, encounter.getUuid());
//        newValues.put(EncounterTable.Column.VISIT_KEY_ID, encounter.getVisitID());
//        newValues.put(EncounterTable.Column.DISPLAY, encounter.getDisplay());
